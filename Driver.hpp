...
class Driver {
    ...
    public:
        ...
        bool is_creatable(Expression expression);
        ...
        std::vector<Expression> generate_call(Expression expression_1, Expression expression_2);
        ...
        std::vector<Expression> generate_return(Expression expression);
        std::vector<Expression> generate_parameter(Expression expression_1, Expression expressions_2);
